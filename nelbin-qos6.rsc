# apr/28/2017 10:37:26 by RouterOS 6.38.5
...
add kind=pcq name=ping_pkts_o_32K pcq-classifier=src-address \
    pcq-dst-address6-mask=64 pcq-rate=32k pcq-src-address6-mask=64
/queue tree
add max-limit=9500k name=IN parent=global priority=2 queue=default
add max-limit=750k name=OUT parent=global priority=2 queue=default
...
add name=1.Ping packet-mark=ping_pkts_i parent=global priority=1 queue=\
    ping_pkts_i_32K
add name=1.Ping-U packet-mark=ping_pkts_o parent=global priority=1 queue=\
    ping_pkts_o_32K
/ip address
...
add action=mark-packet chain=prerouting connection-mark=icmp new-packet-mark=\
    ping_pkts_i passthrough=no
add action=mark-packet chain=prerouting connection-mark=icmp new-packet-mark=\
    ping_pkts_o passthrough=no
...
add action=mark-packet chain=prerouting connection-mark=dns new-packet-mark=\
    service-in passthrough=no src-address=!192.168.1.0/24
add action=mark-packet chain=prerouting connection-mark=dns new-packet-mark=\
    service-out passthrough=no src-address=192.168.1.0/24
...
add action=mark-packet chain=prerouting connection-mark=games \
...
add action=mark-connection chain=prerouting comment=video layer7-protocol=\
    youtube new-connection-mark=video passthrough=yes
add action=mark-packet chain=prerouting connection-mark=video \
    ...
    src-address-list=""
add action=mark-packet chain=prerouting connection-mark=video \
    new-packet-mark=video-out passthrough=no src-address=192.168.1.0/24
...
add action=mark-packet chain=prerouting connection-bytes=0-500000 \
    connection-mark=http new-packet-mark=browsing-in passthrough=no \
    src-address=!192.168.1.0/24
add action=mark-packet chain=prerouting connection-bytes=500000-0 \
    connection-mark=http new-packet-mark=downloads-in passthrough=no \
    src-address=!192.168.1.0/24
add action=mark-packet chain=prerouting connection-bytes=0-200000 \
    connection-mark=http new-packet-mark=http-out passthrough=no src-address=\
    192.168.1.0/24
add action=mark-packet chain=prerouting connection-bytes=200000-0 \
    connection-mark=http new-packet-mark=uploads-out passthrough=no \
    src-address=192.168.1.0/24
add action=mark-connection chain=prerouting comment=quic new-connection-mark=\
    quic passthrough=yes port=80,443 protocol=udp
add action=mark-packet chain=prerouting connection-bytes=0-500000 \
    connection-mark=quic new-packet-mark=browsing-in passthrough=no \
    src-address=!192.168.1.0/24
add action=mark-packet chain=prerouting connection-bytes=500000-0 \
    connection-mark=quic new-packet-mark=downloads-in passthrough=no \
    src-address=!192.168.1.0/24
add action=mark-packet chain=prerouting connection-bytes=0-200000 \
    connection-mark=quic new-packet-mark=http-out passthrough=no src-address=\
    192.168.1.0/24
add action=mark-packet chain=prerouting connection-bytes=200000-0 \
    connection-mark=quic new-packet-mark=uploads-out passthrough=no \
    src-address=192.168.1.0/24
...
add action=mark-packet chain=prerouting connection-mark=downloads \
    new-packet-mark=downloads-in passthrough=no src-address=!192.168.1.0/24
add action=mark-packet chain=prerouting connection-mark=downloads \
    new-packet-mark=uploads-out passthrough=no src-address=192.168.1.0/24
add action=mark-connection chain=prerouting comment=all new-connection-mark=\
    bulk passthrough=yes
add action=mark-packet chain=prerouting connection-mark=bulk new-packet-mark=\
    bulk-in passthrough=no src-address=!192.168.1.0/24
add action=mark-packet chain=prerouting connection-mark=bulk new-packet-mark=\
    bulk-out passthrough=no src-address=192.168.1.0/24
/ip firewall nat
