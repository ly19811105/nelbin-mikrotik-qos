# apr/28/2017 11:49:05 by RouterOS 6.38.5
...
add kind=pcq name=PCQ-IN pcq-classifier=dst-address pcq-dst-address6-mask=64 \
    pcq-src-address6-mask=64 pcq-total-limit=750000KiB
add kind=pcq name=ping_pcq_32_in pcq-classifier=dst-address \
    pcq-dst-address6-mask=64 pcq-rate=32k pcq-src-address6-mask=64
add kind=pcq name=ping_pcq_32k_out pcq-classifier=src-address \
    pcq-dst-address6-mask=64 pcq-rate=32k pcq-src-address6-mask=64
/queue tree
...
add name=1.Ping packet-mark=ping_pkts_i parent=IN priority=1 queue=\
    ping_pcq_32_in
add name=1.Ping-U packet-mark=ping_pkts_o parent=OUT priority=1 queue=\
    ping_pcq_32k_out
/ip address
...
add action=mark-connection chain=prerouting new-connection-mark=http \
