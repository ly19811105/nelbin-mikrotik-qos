# apr/28/2017 21:40:50 by RouterOS 6.38.5
...
/queue tree
add max-limit=9500k name=IN parent=lan queue=pcq-download-default
add max-limit=700k name=OUT parent=wan queue=pcq-upload-default
add limit-at=500k max-limit=8M name=4.Browsing packet-mark=browsing parent=IN \
    priority=4 queue=pcq-download-default
add limit-at=500k max-limit=8M name=5.Video packet-mark=video parent=IN \
    priority=5 queue=pcq-download-default
add limit-at=500k max-limit=1M name=2.Games packet-mark=games parent=IN \
    priority=2 queue=pcq-download-default
add limit-at=500k max-limit=8M name=6.Downloads packet-mark=transfer parent=\
    IN priority=6 queue=pcq-download-default
add limit-at=40k max-limit=600k name=6.Uploads-o packet-mark=transfer parent=\
    OUT priority=6 queue=pcq-upload-default
add limit-at=40k max-limit=400k name=2.Games-o packet-mark=games parent=OUT \
    priority=2 queue=pcq-upload-default
add limit-at=40k max-limit=200k name=4.Browsing-o packet-mark=browsing \
    parent=OUT priority=4 queue=pcq-upload-default
add limit-at=100k max-limit=400k name=5.Video-o packet-mark=video parent=OUT \
    priority=5 queue=pcq-upload-default
add limit-at=500k max-limit=9M name=8.Bulk packet-mark=bulk parent=IN queue=\
    pcq-download-default
add limit-at=40k max-limit=500k name=8.Bulk-o packet-mark=bulk parent=OUT \
    queue=pcq-upload-default
add limit-at=500k max-limit=1M name=3.VOIP packet-mark=voip parent=IN \
    priority=3 queue=pcq-download-default
add limit-at=40k max-limit=400k name=3.VOIP-o packet-mark=voip parent=OUT \
    priority=3 queue=pcq-upload-default
add limit-at=500k max-limit=2M name=1.Service packet-mark=service parent=IN \
    priority=1 queue=pcq-download-default
add limit-at=40k max-limit=400k name=1.Service-o packet-mark=service parent=\
